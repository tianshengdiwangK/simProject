...
import (
	...
	zapLog "github.com/tianshengdiwangK/simProject/basic/log"
	"go.uber.org/zap"
	"image"
	"image/gif"
	"image/jpeg"
...
func GetOriginImage(context *gin.Context) {
	...
	logger.Infof("图片路径：%s", originImagePath)

	http.ServeFile(context.Writer, context.Request, originImagePath)
}
func GetImageExample(context *gin.Context) {
	http.ServeFile(context.Writer, context.Request, "upload/images/f91708e6644098ea351341e028326928.jpg")
}
